"""
Django settings for ecep_backend project.
...
SECRET_KEY = 'django-insecure-*cwhziytco#$ij#!smab#gnkf)xd4l0hammm!9_rh-r37s_2&4'
...
ROOT_URLCONF = 'ecep_backend.urls'
...
WSGI_APPLICATION = 'ecep_backend.wsgi.application'
