...
urlpatterns = [
    ...
    path('api/exercises/submit/', submit_exercise, name='submit_exercise'), 
    ...
    path('historique/enregistrer/',enregistrer_action,name='historique'),
    path('historique/',voir_historique,name='vue_historique'),
    ]